...
namespace PlayerConfig {
	...
	constexpr int HITBOX_SIZE = 16;		//画像のサイズ
	constexpr int PIC_SIZE = 32;		//画像のサイズ
}
namespace PlayerSightMarkerConfig{
	constexpr int SIGHT_HITBOX_SIZE = 16;		//画像のサイズ
	constexpr int SIGHT_PIC_SIZE = 16;		//画像のサイズ
}

namespace PlayerShotConfig {
	constexpr int MAX_SHOT = 3;		//画面内に表示できるショットの数
	constexpr int SPEED = 20;	//ショットの弾速
	constexpr int HITBOX_SIZE = 8;		//画像のサイズ
	constexpr int PIC_SIZE = 8;		//画像のサイズ
}
namespace PlayerBomConfig {
	constexpr int SPEED = 5;		//ショットの弾速
	constexpr int RANGE = 100;		//ボムの射程距離
