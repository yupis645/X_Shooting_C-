...
{
public:
    EnemysManager(std::shared_ptr<IPlayer> pl,
    ...
    void CreateAirEnemy(AirEnemytype type);
    void CreateGroundEnemy(GroundEnemytype type);
...
protected:
    ...
    std::shared_ptr<IMapManager> mapdata_;
