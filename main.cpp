...
LPCWSTR g_szAppName = L"DirectX_XTKGame";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"DirectX_XTKGameWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DirectX_XTKGameWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
            nullptr, nullptr, hInstance,
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"DirectX_XTKGameWindowClass", g_szAppName, WS_POPUP,
        ...
        //ゲームの初期設定
        g_game->Initialize(hwnd, hInstance, rc.right - rc.left, rc.bottom - rc.top);
    }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    auto game = reinterpret_cast<GameManager*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
